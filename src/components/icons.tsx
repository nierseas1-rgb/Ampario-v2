...
export const BathIcon = (props: IconProps) => (
  <svg {...base(props)}>
    <path d="M9 6 6.5 3.5a1.5 1.5 0 0 0-1-.5C4.683 3 4 3.683 4 4.5V17a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5H2M7 19v2M17 19v2M5 12V5.5a1.5 1.5 0 0 1 3 0V6" />
  </svg>
);

export const RulerIcon = (props: IconProps) => (
  <svg {...base(props)}>
    <path d="M21.3 8.7 8.7 21.3a1 1 0 0 1-1.4 0l-4.6-4.6a1 1 0 0 1 0-1.4L15.3 2.7a1 1 0 0 1 1.4 0l4.6 4.6a1 1 0 0 1 0 1.4ZM7.5 10.5l2 2M11 7l2 2M14.5 3.5l2 2M3.5 14.5l2 2" />
  </svg>
);

export const RoomsIcon = (props: IconProps) => (
  <svg {...base(props)}>
...
export const HomeIcon = (props: IconProps) => (
  <svg {...base(props)}>
    <path d="M3 9.5 12 3l9 6.5M5 10v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V10" />
  </svg>
);
